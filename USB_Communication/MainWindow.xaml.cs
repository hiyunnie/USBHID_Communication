...
namespace USB_Communication
{
    public partial class MainWindow : Window
    {
        ...
        void    Byte0_TextInput(object sender, EventArgs e)
        {
            Byte.TryParse(Byte0.Text, NumberStyles.HexNumber, CultureInfo.InvariantCulture, out WriteData[0]);
        }
        void    Byte1_TextInput(object sender, EventArgs e)
        {
            Byte.TryParse(Byte1.Text, NumberStyles.HexNumber, CultureInfo.InvariantCulture, out WriteData[1]);
        }
        void    Byte2_TextInput(object sender, EventArgs e)
        {
            Byte.TryParse(Byte2.Text, NumberStyles.HexNumber, CultureInfo.InvariantCulture, out WriteData[2]);
        }
        void    Byte3_TextInput(object sender, EventArgs e)
        {
            Byte.TryParse(Byte3.Text, NumberStyles.HexNumber, CultureInfo.InvariantCulture, out WriteData[3]);
        }
        void    Byte4_TextInput(object sender, EventArgs e)
        {
            Byte.TryParse(Byte4.Text, NumberStyles.HexNumber, CultureInfo.InvariantCulture, out WriteData[4]);
        }
        void    Byte5_TextInput(object sender, EventArgs e)
        {
            Byte.TryParse(Byte5.Text, NumberStyles.HexNumber, CultureInfo.InvariantCulture, out WriteData[5]);
        }
        void    Byte6_TextInput(object sender, EventArgs e)
        {
            Byte.TryParse(Byte6.Text, NumberStyles.HexNumber, CultureInfo.InvariantCulture, out WriteData[6]);
        }
        void    Byte7_TextInput(object sender, EventArgs e)
        {
            Byte.TryParse(Byte7.Text, NumberStyles.HexNumber, CultureInfo.InvariantCulture, out WriteData[7]);
        }

        void    HIDRead_Button_Click(object sender, EventArgs e)
        {
        ...
        void    HIDWrite_Button_Click(object sender, EventArgs e)
        {
